...
def reid_camera_links(
    ...
    links = [
        ReidCameraLink(
            ...
            attribute_comparable_count=item.attribute_comparable_count,
            attribute_match_count=item.attribute_match_count,
            attribute_conflict_count=item.attribute_conflict_count,
